...
class AppButton extends StatelessWidget {
  ...
  /// Outlined transparent white button.
  const AppButton.outlinedCardFields({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
    TextStyle? textStyle,
          ...
          onPressed: onPressed,
          child: child,
          buttonColor: AppColors.whiteCardField,
          borderSide: const BorderSide(
            color: AppColors.white,
          ),
          elevation: elevation,
  ...
  /// filled Darkgreen button
  const AppButton.filledDarkGreen({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
  ...
  const AppButton.filledGreen({
    ...
    TextStyle? textStyle,
          ...
          disabledButtonColor: AppColors.green,
          textStyle: textStyle,
        );
  ...
  const AppButton.verySmallPurple({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
          ...
          foregroundColor: AppColors.white,
          elevation: elevation,
          maximumSize: _reallySmallMaximumSize,
          minimumSize: _reallySmallMinimumSize,
          padding: _reallySmallPadding,
        );

  /// Filled small green button.
  const AppButton.smallPurple({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
    bool? isLoading,
          ...
          onPressed: onPressed,
          buttonColor: AppColors.purple,
          disabledButtonColor: AppColors.grey,
          disabledForegroundColor: AppColors.white,
          child: child,
          isLoading: isLoading,
          foregroundColor: AppColors.white,
          elevation: elevation,
          maximumSize: _mediumMaximumSize,
          minimumSize: _mediumMinimumSize,
  ...
  static const _mediumMaximumSize = Size(double.infinity, 50);

  /// The minimum size of the small variant of the button.
  static const _mediumMinimumSize = Size(120, 40);
  ...
  /// The maximum size of the small variant of the button.
  static const _reallySmallMaximumSize = Size(double.infinity, 50);

  /// The minimum size of the small variant of the button.
  static const _reallySmallMinimumSize = Size(50, 50);
  ...
  /// The padding of the small variant of the button.
  static const _reallySmallPadding =
      EdgeInsets.symmetric(horizontal: AppSpacing.sm);

  /// The padding of the small variant of the button.
  static const _mediumPadding = EdgeInsets.symmetric(horizontal: AppSpacing.lg);

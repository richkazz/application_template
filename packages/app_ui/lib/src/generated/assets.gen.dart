...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/expenditure_nav_botton.svg
  SvgGenImage get expenditureNavBotton =>
      const SvgGenImage('assets/icons/expenditure_nav_botton.svg');
  ...
  /// File path: assets/icons/home_line.svg
  SvgGenImage get homeLine => const SvgGenImage('assets/icons/home_line.svg');
  ...
  /// File path: assets/icons/profile_nav_button.svg
  SvgGenImage get profileNavButton =>
      const SvgGenImage('assets/icons/profile_nav_button.svg');
  ...
  /// File path: assets/icons/transactions_nav_button.svg
  SvgGenImage get transactionsNavButton =>
      const SvgGenImage('assets/icons/transactions_nav_button.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/naira-coin-free-vector.png
  AssetGenImage get nairaCoinFreeVector =>
      const AssetGenImage('assets/images/naira-coin-free-vector.png');

  /// File path: assets/images/navbar_image.png
  AssetGenImage get navbarImage =>
      const AssetGenImage('assets/images/navbar_image.png');

  /// File path: assets/images/paypal_monochromatic.svg
  SvgGenImage get paypalMonochromatic =>
      const SvgGenImage('assets/images/paypal_monochromatic.svg');

  /// File path: assets/images/porkys-saving.png
  AssetGenImage get porkysSaving =>
      const AssetGenImage('assets/images/porkys-saving.png');

  /// File path: assets/images/profile_boy.png
  AssetGenImage get profileBoyPng =>
      const AssetGenImage('assets/images/profile_boy.png');

  /// File path: assets/images/profile_boy.svg
  SvgGenImage get profileBoySvg =>
      const SvgGenImage('assets/images/profile_boy.svg');

  /// File path: assets/images/splash_screen_shape_buttom.svg
  SvgGenImage get splashScreenShapeButtom =>
      const SvgGenImage('assets/images/splash_screen_shape_buttom.svg');
